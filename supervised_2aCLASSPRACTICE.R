...
setwd("C:/Users/16108/Documents/GitHub/TAD_2021")
...
#with less features to run performance is less precise 
...
#prior argument refers to prior distribution of uniform, docfreq, or termfreq on texts.
#in quanteda the default is uniform priors
...
#the outcomes should be the same as computed docfreq is equivalent to uniform priors 