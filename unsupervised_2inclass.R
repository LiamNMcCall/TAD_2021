...
# Load data
blm_tweets [1:5000] <- read.csv("blm_samp.csv", stringsAsFactors = F)
...
#it seems the best number of topics is 19
#### Do you think that the number of topics is linear in the number of documents??

# the number of topics seems to not be linear, if it were I would expect a higher number of topics
